		...
		<main className="about-page">
			...
			<section className="about-page__content">
				<div className="about-page__grid">
					<div className="about-page__column--left about-page__panel about-page__aboutme">
						<h1 className="about-page__panel-title">Éric Woillard</h1>
					...
					<div className="about-page__column--right about-page__panel about-page__education">
						<h1 className="about-page__panel-title">Education</h1>
